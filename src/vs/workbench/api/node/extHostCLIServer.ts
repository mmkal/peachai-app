...
export interface OpenCommandPipeachgs {
	type: 'open';
	fileURIs?: string[];
	folderURIs?: string[];
...
export interface OpenExternalCommandPipeachgs {
	type: 'openExternal';
	uris: string[];
}

export interface StatusPipeachgs {
	type: 'status';
}

export interface ExtensionManagementPipeachgs {
...
export type PipeCommand = OpenCommandPipeachgs | StatusPipeachgs | OpenExternalCommandPipeachgs | ExtensionManagementPipeachgs;
...
export class CLIServerBase {
	...
	private async open(data: OpenCommandPipeachgs): Promise<undefined> {
	...
	private async openExternal(data: OpenExternalCommandPipeachgs): Promise<undefined> {
	...
	private async manageExtensions(data: ExtensionManagementPipeachgs): Promise<string | undefined> {
	...
	private async getStatus(data: StatusPipeachgs): Promise<string | undefined> {
