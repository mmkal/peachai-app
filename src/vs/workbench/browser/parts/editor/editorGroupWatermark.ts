...
const openpeachAIChat: WatermarkEntry = { text: localize('watermark.openpeachAIChat', "Open Chat"), id: 'peachai.focusContinueInput', when: ContextKeyExpr.has('peachAIExtensionLoaded') };
const bigChat: WatermarkEntry = { text: localize('watermark.peachAIBigChat', "Big Chat"), id: 'peachai.resizeAuxiliaryBarWidth', when: ContextKeyExpr.has('peachAIExtensionLoaded') };
const prevChat: WatermarkEntry = { text: localize('watermark.peachAIPrevChat', "Previous Chat"), id: 'peachai.loadRecentChat', when: ContextKeyExpr.has('peachAIExtensionLoaded') };
...
export class EditorGroupWatermark extends Disposable {
	...
	private async render(): Promise<void> {
		...
		this.contextKeyService.createKey('peachAIExtensionLoaded', true); // Set a context key when the peachAI extension is loaded
