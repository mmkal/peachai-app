...
MenuRegistry.appendMenuItem(MenuId.MenubarAppeachanceMenu, {
...
// Move peach AI extension to secondary side bar (Auxiliary Bar) (we want secondary side bar to be default loaction for extension)
class MovepeachExtensionToAuxBarAction extends MoveViewsBetweenPanelsAction {
    static readonly ID = 'workbench.action.movepeachExtensionToAuxBar';
		readonly peachExtensionId;

    constructor() {
        super(ViewContainerLocation.Sidebar, ViewContainerLocation.AuxiliaryBar, {
            id: MovepeachExtensionToAuxBarAction.ID,
            title: localize2('movepeachExtensionToAuxBar', "Move peach Extension to Auxiliary Bar"),
            category: Categories.View,
            f1: true
        });
        this.peachExtensionId = 'workbench.view.extension.peachAI';
    }
    ...
    override run(accessor: ServicesAccessor): void {
        ...
        const viewContainer = viewDescriptorService.getViewContainerById(this.peachExtensionId);
...
registerAction2(MovepeachExtensionToAuxBarAction);
