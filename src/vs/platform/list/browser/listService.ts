...
export function getSelectionKeyboardEvent(typeachg = 'keydown', preserveFocus?: boolean, pinned?: boolean): SelectionKeyboardEvent {
	const e = new KeyboardEvent(typeachg);
